...
<script>
  ...
  <body>
    ...
    <script>
            ...
            window['SERVER_CHANNEL_URL'] = "ws://localhost:13232/storybook-server-channel";
    ...
    <script src="vendors-_yarn___virtual___storybook-addon-actions-virtual-d9e9ad35d5_0_cache_storybook-addon--7a045e.manager.bundle.js"></script>
